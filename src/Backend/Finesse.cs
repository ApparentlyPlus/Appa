...
internal static class Finesse
{
	...
	static readonly string[] Taglines =
	[
		// Avatar / bison-themed
	...
	static readonly string[] EmotionalStates =
	[
	...
	static readonly string[] AiLines =
	[
	...
	static readonly string[] LoadingLines =
	[
		"Initializing code...",
	...
	static readonly string[] WarningLines =
	[
	...
	static readonly string[] Discoveries =
	[
	...
	static readonly string[] Forecasts =
	[
	...
	static readonly string[] NightEntries =
	[
	...
	static readonly string[] Absurdisms =
	[
	...
	/// </summary>
	static string Sep(char c, int width) => new string(c, width);
	...
	/// </summary>
	static string Card(string fileName)
	{
...
""";
	...
	/// </summary>
	static string Terminal(string fileName) => $"""
/*
...
""";
	...
	/// </summary>
	static string AiAwakening(string fileName) => $"""
/*
 * {Pick(Greetings)}
 *
 * I am {fileName}.
...
""";
	...
	/// </summary>
	static string AncientArtifact(string fileName)
	{
...
""";
	...
	/// </summary>
	static string LoadingScreen(string fileName) => $"""
/*
 * Loading {fileName}...
 *
 * [##############################] 100%
...
""";
	...
	/// </summary>
	static string Demoscene(string fileName) => $"""
/* 
 *               _.-````'-,_
 *   _,.,_ ,-'`           `'-.,_
 * /)     (\                   '``-.
...
""";
	...
	/// </summary>
	static string Propaganda(string fileName) => $"""
/*
 * ATTENTION CITIZEN
 *
 * FILE IDENTIFIER:
...
""";
	...
	/// </summary>
	static string SpaceMission(string fileName) => $"""
/*
...
""";
	...
	/// </summary>
	static string ProgrammerThoughts(string fileName) => $"""
/*
 * Fun fact:
 *
...
""";
	...
	/// </summary>
	static string Mythological(string fileName) => $"""
/*
 * In ancient times,
...
""";
	...
	/// </summary>
	static string Bureaucratic(string fileName) => $"""
/*
...
""";
	...
	/// </summary>
	static string WeatherReport(string fileName) => $"""
/*
...
""";
	...
	/// </summary>
	static string GameOver(string fileName) => $"""
/*
 *  ██████╗  █████╗ ███╗   ███╗███████╗     ██████╗ ██╗   ██╗███████╗██████╗
 * ██╔════╝ ██╔══██╗████╗ ████║██╔════╝    ██╔═══██╗██║   ██║██╔════╝██╔══██╗
 * ██║  ███╗███████║██╔████╔██║█████╗      ██║   ██║██║   ██║█████╗  ██████╔╝
...
""";
	...
	/// </summary>
	static string NightLog(string fileName) => $"""
/*
...
""";
	...
	/// </summary>
	static string StatusBoard(string fileName)
	{
...
""";
	...
	/// </summary>
	static string WarningLabel(string fileName) => $"""
/*
 * FILE: {fileName}
 *
 * {Pick(WarningLines)}
...
""";
	...
	/// </summary>
	static string LegendaryHeader(string fileName)
	{
