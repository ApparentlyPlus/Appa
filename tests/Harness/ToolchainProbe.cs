...
/// <summary>
/// Cheap presence check for the GatOS cross toolchain that BootTests shells out to. Used to skip
/// gracefully rather than fail when a machine lacks the toolchain.
/// </summary>
